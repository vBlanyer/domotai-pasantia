...
\begin{itemize}
  ...
  \item \textbf{Lazo en vivo.} Un conector que traduce cada acción abstracta del catálogo cerrado a
        ...
        reiniciarse, para que varias sesiones formen una sola. Lo que la cadena no cubre se deja
        escrito junto a ella: el truncado del fichero por el final no se detecta, porque lo que
        queda sigue encadenado, y cubrirlo exige anclar el último resumen fuera del fichero. En
...
este informe, asciende a 325 casos ---261 del motor de triaje, 31 del marco de evaluación y 33 de
