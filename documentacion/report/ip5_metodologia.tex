...
este informe, asciende a 239 casos ---178 del motor de triaje, 28 del marco de evaluación y 33 de
la tubería de construcción del conjunto de datos---, ejecutados con generadores y ejecutores
simulados que permiten probar la lógica de decisión, de idempotencia, de escalada y de degradación
sin necesidad de un modelo de lenguaje cargado ni de un laboratorio en ejecución.
