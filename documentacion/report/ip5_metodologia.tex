...
incidente cuya contención en el propio equipo no basta, razona la escalada hacia el siguiente nodo
con capacidad de contención ---del anfitrión al cortafuegos--- consultando el corpus de conocimiento
como herramienta y solicitando aprobación humana en cada paso. Para ejercitar esa escalada se añadió
al laboratorio una topología con un equipo de borde administrable, y un banco de escenarios de
ataque organizados por el comportamiento que deben provocar en el motor.
