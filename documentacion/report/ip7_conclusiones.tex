...
objetivo se cumplió dentro del caso de uso acotado sobre el que se evaluó: el prototipo redujo la
tasa de falsos positivos frente al nivel de regla de Wazuh en un factor cercano a siete, sin dejar
de detectar ninguna amenaza real y sin ejecutar ninguna acción que hubiera interrumpido
...
El trabajo deja, con la misma honestidad con que reporta sus logros, dos límites identificados y no
resueltos. El primero es la precisión del clasificador determinista, limitada por su incapacidad de
distinguir un administrador legítimo de un atacante sobre el mismo servicio: es exactamente el
problema que un clasificador con ajuste fino resolvería, y que permanece bloqueado porque el
conjunto de datos disponible, concentrado en una sola familia de ataque, no ofrece variedad
suficiente para entrenarlo sin invalidar la propia evaluación. El segundo es el alcance estadístico
de la evaluación misma: dieciocho alertas soportadas, todas del mismo activo y servicio, sostienen
un resultado direccionalmente claro pero no permiten generalizar sus cifras exactas a un cliente con
un perfil de amenazas distinto.
