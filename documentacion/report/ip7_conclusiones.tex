...
\begin{itemize}
  ...
  \item \textbf{Verificar que la técnica citada en la justificación sea la de la alerta.} La
        verificación de anclaje comprueba direcciones y campos, pero no que el identificador de
        técnica que el texto menciona coincida con el de la alerta, y se observó en una corrida
        que el modelo atribuía a la alerta una técnica procedente de un pasaje recuperado. Es la
        misma clase de defecto que las contradicciones ya corregidas ---material de referencia
        narrado como hecho--- y se detecta con la misma facilidad, comparando contra un campo
        estructurado.
