...
nada que no haya declarado poder ejecutar. Quedan fuera, y se dicen: el anclaje del último resumen
de la traza fuera del fichero, sin el cual un truncado por el final no se detecta; y la rotación de
la clave del conector, que el aprovisionamiento crea pero no renueva.
