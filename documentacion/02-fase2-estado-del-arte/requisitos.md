...
| RF-07 | Aplicar reglas y umbrales configurables que determinen cuándo se escala a validación humana | Fase 4 | ~ Reglas configurables en `perfil.continuidad`/`excepciones`; el **umbral de confianza** también (`continuidad.umbral_confianza`, 0.7 por defecto). Su valor **calibrado** sigue pendiente (Fase 6 midió escalado 0.0) |
