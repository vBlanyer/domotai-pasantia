...
| RF-13 | Exponer los resultados al sistema del cliente mediante una interfaz definida, sin sustituir sus funciones | XDR §5 | ~ La **traza JSONL es la interfaz de salida definida** (esquema estable de `traza.construir`); el push al sistema del cliente es trabajo de producción (ejecutores por plano de control, ver [protocolos §7](../04-fase4-diseno-de-arquitectura/protocolos-comunicacion-sandbox.md)) |
