...
| RNF-04 | **Latencia:** tiempo de triaje del orden de segundos en el camino interactivo | XDR §2 | ~ Clasificar+decidir es sub-ms; justificar con el LLM 1B ~14–36 s (medido, recarga del modelo por subprocess), al límite de lo tolerable para validación humana. Documentado; no aplica al camino en lote |
