...
| [3 — Entorno de pruebas](03-fase3-entorno-de-pruebas/) | Diseño del laboratorio (ejecutable en [`lab/`](../lab/)) y el dataset etiquetado y particionado | Completa (600 alertas etiquetadas) |
