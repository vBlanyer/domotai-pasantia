...
- **Calibración del umbral de escalado (RF-07).** `continuidad.umbral_confianza` sin calibrar (0,7 por
  defecto). Escalado medido en la campaña vigente: **0,067** (20/300, todas VP: las ráfagas desde el origen de
  administración, 6ª regla). Falta el barrido del umbral (curva escalado ↔ errores de auto-bloqueo).
