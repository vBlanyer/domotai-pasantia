...
| D11 | La interacción humana del prototipo es **por terminal (TUI/CLI)** y, desde v1, también por una **UI web local** (`prototipo/tablero.py`, `stream.py --web`): observabilidad (salud, decisiones, trazas) y aprobación desde el navegador, ligada solo a `127.0.0.1` y **sin autenticación**. Login y TLS quedan como **trabajo futuro** | [flujo §7](../04-fase4-diseno-de-arquitectura/flujo-triaje-playbook-sandbox.md) · [pruebas 09](../../docs/pruebas/09-tablero-web.md) |
