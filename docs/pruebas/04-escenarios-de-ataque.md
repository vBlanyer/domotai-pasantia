...
| **D. Falso positivo** | admin declarado (origen legítimo) | inyección | `fp_actividad_legitima`, sin acción |
...
Alerta idéntica a un ataque pero desde una IP declarada en `origenes_legitimos` del perfil (192.168.1.1) →
el motor la clasifica **FP** y **no ejecuta** (RF-03).
