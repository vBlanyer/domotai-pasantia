...
| **Marco de evaluación** (métricas contra el baseline de Wazuh) | `evaluacion/` (aún no creado) | En construcción (Fase 6) |
...
- **`evaluacion/`** — el marco de medición (la Fase 6, aún no creado).
- **[`docs/superpowers/`](docs/superpowers/)** — las especificaciones y planes de implementación de cada
  subproyecto de código.

## Estado del proyecto

Fases 1–5 completas; la 6 (evaluación) en curso; la 7 (informe) pendiente. El detalle vivo del estado,
